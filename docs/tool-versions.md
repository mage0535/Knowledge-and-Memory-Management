...
| 脚本 | 来源 | 位置 |
|------|------|------|
| trivy_bridge.py | aquasecurity/trivy (24k⭐) | $AGENT_HOME/scripts/trivy_bridge.py 🆕 |
| specify_bridge.py | github/spec-kit (15k⭐) | $AGENT_HOME/scripts/specify_bridge.py 🆕 |
| copilot_sdk_bridge.py | github/copilot-sdk (9.2k⭐) | $AGENT_HOME/scripts/copilot_sdk_bridge.py 🆕 |
| paddleocr_bridge.py | PaddlePaddle/PaddleOCR (70k⭐) | $AGENT_HOME/scripts/paddleocr_bridge.py 🆕 |
